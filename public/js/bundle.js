    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          res = _context3.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)('success', "Registered In Successfully");
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var coord = locations[0].coordinates;
  function initMap() {
    return _initMap.apply(this, arguments);
  }
  function _initMap() {
    _initMap = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var _yield$google$maps$im, Map, InfoWindow, _yield$google$maps$im2, AdvancedMarkerElement, myLatlng, mapOptions, map, bounds;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
          ...
          case 7:
            ...
            myLatlng = new google.maps.LatLng(coord[1], coord[0]);
            mapOptions = {
              zoom: 3,
              center: myLatlng,
              mapTypeId: 'roadmap',
            ...
            locations.forEach(function (loc) {
              ...
              el.className = 'marker';
              var myLatlng = new google.maps.LatLng(loc.coordinates[1], loc.coordinates[0]);
              var contentString = "<div class=\"popup\">Day ".concat(loc.day, " : ").concat(loc.description, "</div>");
              ...
              var marker = new AdvancedMarkerElement({
                map: map,
                position: myLatlng,
                title: "Day ".concat(loc.day, " : ").concat(loc.description),
                content: el
              });
              marker.setMap(map);
              infowindow.open({
...
var userData = exports.userData = /*#__PURE__*/function () {
  ...
  return function userData(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51Op2xvSDKsAVOdzPRYtwk6UWSJ9BzNfbBoPCPgCrCuzkcSxgBW6PlE87lqqsZsWZAt8EzlkM9AQv0dh20wA5fWUX00EVO0mQZG');
...
var updatePasswordBtn = document.querySelector('.btn--newpassword');
...
if (signupForm) {
  document.querySelector('.signup-form').addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var form, name, email, password, passwordConfirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
...
if (updateDataBtn) {
  document.querySelector('.btn--save--setting').addEventListener('click', function (e) {
    e.preventDefault();
    var form = new FormData();
    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]);
    (0, _updateSetting.userData)(form, 'data');
  });
}
if (updatePasswordBtn) {
  document.querySelector('.btn--newpassword').addEventListener('click', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 7;
            return (0, _updateSetting.userData)({
